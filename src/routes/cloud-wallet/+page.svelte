  ...
  >
    <form method="POST" action="?/pay">
      <div class="flex flex-wrap -mx-3 mb-2">
        ...
        <button type="submit" class="bg-yellow-500 hover:bg-blue-700 text-white font-bold py-2 px-4 mt-5 ml-2 rounded shadow-md transition duration-300">
          Pay
      </button> 
      </div>
    </form>
    ...
    <!-- this message is ephemeral; it exists because the page was rendered in
      ...
      <p class="pt-2 text-green-600 font-semibold">The payment was successful. Here is your <a href="https://whatsonchain.com/tx/{form?.payment}" class="text-blue-500 underline" target="_blank">transaction</a>!</p>
  {/if}
  </div>